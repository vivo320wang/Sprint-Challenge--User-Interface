...
<!-- because it can be used to track changes of your code, allowing multiple developers to work together, and make collaboration of projects more easy among team members. -->
5. Define mobile-first design in your own words.
   <!-- start working on the smallest screen first then work your way up to larger screens -->
